...
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @if (session('theme')) data-theme="{{ session('theme') }}" @endif @class(["min-h-screen bg-base-200", "hotwire-native" => Turbo::isHotwireNativeVisit()]) >
    <head>
